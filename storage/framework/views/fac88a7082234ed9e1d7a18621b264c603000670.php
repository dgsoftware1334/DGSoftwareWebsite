...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.authentication-card','data' => ['style' => 'background-image: url(\'assets/img/banner/logoHeader.jpg\');']]); ?>
<?php $component->withName('jet-authentication-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['style' => 'background-image: url(\'assets/img/banner/logoHeader.jpg\');']); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?> 
<?php /**PATH C:\laragon\www\E-ECG\resources\views\auth\forgot-password.blade.php ENDPATH**/ ?>