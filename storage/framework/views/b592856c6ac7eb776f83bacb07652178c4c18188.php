					...
					<div class="col-md-3">
						<div class="side-bar-widget first-widget">
							...
							<div class="genius-btn gradient-bg text-center text-uppercase ul-li-block bold-font">
								<a href="<?php echo e(url('/cours')); ?>">Voir les cours enligne<i class="fas fa-caret-right"></i></a>
							</div>
						</div>
...
<?php echo $__env->make('layouts.static', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\E-ECG\resources\views/about.blade.php ENDPATH**/ ?>