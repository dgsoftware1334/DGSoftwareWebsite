...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="index.html" class="logo" style="background-color: white"><span style="text-align: center;"><img src="<?php echo e(asset('img/logoo.png')); ?>" height="60px" width="55px"></span></a>
      <!--logo end-->
