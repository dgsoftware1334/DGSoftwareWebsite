      ...
      <ul class="navbar-nav">
        <li class="nav-item">
          <a href="<?php echo e(url('/')); ?>" class="nav-link">
            <i class="now-ui-icons design_app"></i> <?php echo e(__("Accueil")); ?>
...
<!-- End Navbar --><?php /**PATH C:\laragon\www\E-ECG\resources\views/layouts/navbars/navs/guest.blade.php ENDPATH**/ ?>