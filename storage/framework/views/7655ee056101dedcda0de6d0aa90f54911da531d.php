...
<section id="main-content">
 <section class="wrapper">
  ...
  <div class="row mt">
    ...
    <a href="<?php echo e(url('Show/galeire/'.$g->id)); ?>" ><div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 desc gal" style="background: url(storage/<?php echo e($g->main_image); ?>) no-repeat center top; background-position: center center; background-size: cover;">
...
unset($__errorArgs, $__bag); ?>" id="titre" name="titre" type="text" />
                  ...
                  <div class="form-group ">
                    <label for="description" class="control-label col-lg-2">Catégorie</label>
                    <div class="col-lg-10">
                     <input type="text" class=" form-control <?php $__errorArgs = ['catégorie'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="catégorie"  value="<?php echo e(old('catégorie')); ?>"></input>
...
unset($__errorArgs, $__bag); ?>"  value="<?php echo e(old('description')); ?>"></input>
