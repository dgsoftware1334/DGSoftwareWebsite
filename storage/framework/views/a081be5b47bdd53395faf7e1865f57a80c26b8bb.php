...
unset($__errorArgs, $__bag); ?>
							...
							<div class="col-md-6">
								<div class="contact-info">
									<input class="name form-control <?php $__errorArgs = ['prenom'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="prenom" type="text" value="<?php echo e(old('prenom')); ?>" placeholder="Votre Prenom*">
								</div>
								<?php $__errorArgs = ['nom'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?>" name="message" placeholder="Spécification pour votre commande*"><?php echo e(old('message')); ?></textarea>
