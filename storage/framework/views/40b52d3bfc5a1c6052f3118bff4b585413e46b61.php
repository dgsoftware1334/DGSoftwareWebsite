...
unset($__errorArgs, $__bag); ?>" name="name" type="text" placeholder="Votre Nom*">
								</div>
							</div>
							<div class="col-md-4">
								<div class="contact-info">
...
unset($__errorArgs, $__bag); ?>" name="email" type="email" placeholder="Votre Mail*">
								</div>
							</div>
							<div class="col-md-4">
								<div class="contact-info">
...
unset($__errorArgs, $__bag); ?>" name="number" type="number" placeholder="Numéro téléphone*">
								</div>
							</div>
						</div>
