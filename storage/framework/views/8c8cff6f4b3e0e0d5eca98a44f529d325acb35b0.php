...
<img src="<?php echo e(asset('assets/img/android-chrome-512x512.png')); ?>" class="logo" alt="Logo" style="width:180px; height:100px;">

<?php $__env->slot('footer'); ?>
<?php $__env->startComponent('mail::footer'); ?>
© <?php echo e(date('Y')); ?> E-ECG. <?php echo app('translator')->get('All rights reserved.'); ?>
...
<?php endif; ?>
<?php echo $__env->renderComponent(); ?>
<?php /**PATH C:\laragon\www\E-ECG\resources\views/vendor/mail/html/message.blade.php ENDPATH**/ ?>