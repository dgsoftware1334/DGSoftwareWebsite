...
<!-- START BLOG -->
    ...
    <div id="breadcrumb" class="breadcrumb-bg">
        <div class="container">
            <h2 class="head-after">À propos de nous</h2>
            <nav>
                <ul>
		...
		<div class="container">
			<div class="row d-flex align-items-center">
                <div class="col-lg-9">
                    ...
                    <h1><span>{{$presentation[0]->Slogan}}.</h1>
                </div>
                    <div class="col-lg-5">
                        ...
                        <div class="whoweare-item">
                            <div class="whoweare-right">
                                <div class="card">
                                    ...
                                    <a href="{{route('polesActivites.show',$pole->id)}}"><p>{{$pole->NomPole}}</p></a>
                                    @endforeach
                                </div>
                                <div class="card">
                                    <h4>Nos secteurs</h4>
                                    @foreach($AllSecteurs as $secteur)
                                    <a href="{{route('secteurs.show',$secteur->id)}}"><p>{{$secteur->NomSecteur}}</p></a>
                                    @endforeach
                                </div>
                            </div>
                        </div>
		...
		<div class="container">
			<div class="row d-flex align-items-center">
				...
				<div class="col-lg-4">
					<div class="team-item">
						<div class="team-img">
							<img src="{{asset($fondateur->Image)}}" alt="">
						</div>
