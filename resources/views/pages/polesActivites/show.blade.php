		...
		<div class="container myPagesStyle">
			<div class="row d-flex ">
				...
				<div class="col-lg-3">
					...
					<div>
						 <h5 class="myPagesStyleText"><span>Nos Poles d'Activité</span></h5>
					</div>
					...
					<div  class="whoweare-item pb-60px">
						...
						@if( $AllPoles->count() > 0)
						<ul>
						@foreach ($AllPoles as $TmpPole)
                        <a href="{{route('polesActivites.show', $TmpPole->id)}}">
							<div class="costumizeCard">
								<h6><i></i> <b>{{$TmpPole->NomPole}}</b></h6>
							</div>
                        </a>
						@endforeach
										...
										<div class="portfolio-item-single-item">
                                            ...
                                            <div class="portfolio-item-single portfolio-item-single-position-relative">
												...
												<div id="blog1" class="mfp-hide">
													<a href="{{asset($SelectedPoles->Image)}}"></a>
												</div>
											</div>
                                            @endif
											...
											<div class="portfolio-item-single">
												<div class="portfolio-item-card">
													<h5>{{$SelectedPoles->NomPole}}</h5>
													</div>
											</div>

                                            <div class="portfolio-item-single">
												<blockquote class="mb-0 theme-bg-default">
													{{$SelectedPoles->Introduction}}
													
												</blockquote>
											</div>

											<div class="portfolio-item-single">
												{!! $SelectedPoles->Description !!}
											</div>
