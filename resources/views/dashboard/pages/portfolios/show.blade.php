                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-auto">
                                <a href="{{url('portfolios/'.$id.'/create')}}" type="button" class="btn btn-success pull-left mb-3"><i class="fa fa-plus mr-3" aria-hidden="true"></i>Nouveau</a>
                            </div>
                            @if (session('titreAjt'))
                            
                            <div id="alert" class="alert alert-success alert-dismissible fade show" role="alert">
                                Votre nouveau <strong>image</strong> a été ajouter au portfolio 
                            ...
                            <div id="alert" class="alert alert-warning alert-dismissible fade show" role="alert">
                                Votre <strong>image</strong> a été modifier
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                  <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            ...
                            <div id="alert" class="alert alert-danger alert-dismissible fade show" role="alert">
                                Votre <strong>image</strong> a été supprimer 
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                  <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                                                ...
                                                <div class="d-flex justify-content-center">
                                                 ...
                                                 <!-- Modal -->
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        ...
                                                        <form class="form-inline" action="{{ route('portfolios.destroy',$image['id'])}}"  method="POST">
                                                        @method('DELETE')
                                                        @csrf
