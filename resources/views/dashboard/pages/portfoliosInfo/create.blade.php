		...
		<div class="container myPagesStyle">
			<div class="row d-flex ">
				...
				<div class="col-lg-3">
					...
					<a href="{{url('dashboard/'.$service->id.'/portfolio_info')}} ">
				...
				<div class="col-lg-12">
					<div class="get-quote-item">
						...
						<form id="get_quote_form" class="col-form" action="{{ route('portfoliosInfo.store') }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
							<div class="row">
