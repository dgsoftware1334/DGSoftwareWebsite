		...
		<div class="container myPagesStyle">
			<div class="row d-flex ">
				...
				<div class="col-lg-3">
					...
					<div>
						 <h4 class="myPagesStyleText"><span>Nouveau secteur</span></h4>
					</div>
				...
				<div class="col-lg-12">
					<div >
						...
						<form id="get_quote_form" class="col-form" action="{{ route('secteurs.store') }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
							<div class="row">
								...
								<div class="col-lg-6">
									<div class="form-group">
										<input type="text" class="form-control" name="nomSecteur" placeholder="Nom de secteur" value="{{old('nomSecteur')}}">
...
<script>
    $('#summernote').summernote({
      placeholder: 'Description de secteur',
      tabsize: 2,
      height: 400,
	  toolbar: [
