		...
		<div class="container myPagesStyle">
			<div class="row d-flex ">
				...
				<div class="col-lg-3">
					...
					<div>
						 <h4 class="myPagesStyleText"><span>Nouveau service</span></h4>
					</div>
				...
				<div class="col-lg-12">
					<div class="">
						...
						<form id="get_quote_form" class="col-form" action="{{ route('services.store') }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
							<div class="row">
